<template>
    <div class="absolute top-0 right-0 mt-4 mr-4 text-lg bg-green-500 text-white p-2 rounded" v-show="show">
        <div v-if="$page.props.flash.success && show"
            class="flex items-center justify-between  max-w-3xl bg-green-500 rounded">
