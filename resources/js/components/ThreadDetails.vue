                ...
                <div v-if="canUpdate" class="flex items-center space-x-2">
                    <form @submit.prevent="deleteThread">
                        <button title="Delete this thread" type="submit"
                            class="bg-red-50  rounded p-1  hover:outline hover:outline-1 hover:outline-red-500 ring-1 ring-red-400 group">
                            <svg class="w-6 h-6 text-red-700 group-hover:text-red-500 group-hover:scale-95" fill="none"
                    ...
                    <Link title="Update this thread"
                        ...
                        class=" bg-blue-50 text-blue-700 rounded p-1  hover:outline hover:outline-1 hover:outline-blue-500 ring-1 ring-blue-400 group">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="w-6 h-6 group-hover:text-blue-500 group-hover:scale-95">
